...
//     const [categories, setCategories] = useState(['Laptop', 'Tablet', 'Headphones']); // Example categories
...
//         setCategories([...categories, categoryName]); // Example state update
//     };
...
//         try {
//             const response = await axios.get('http://localhost:3000/api/product'); // Make GET request to fetch products
...
//                         </button>
//                         <button
//                             className="bg-yellow-500 text-white px-4 py-2 rounded-md ml-5"
//                             onClick={() => setIsAddSubCategoryOpen(true)}
//                         >
//                             Add sub category
//                         </button>
